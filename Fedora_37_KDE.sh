...
Things that this script change:
 ...
 - Install hardware accelereated video codecs VA-API/VDPAU (SU)
 - Remove PackageKit (SU) (User choice)

Use this script only on Fedora KDE Spin
This script was made particulary for version 37 and it may not work on older releases!
...
# INSTALL VA-API / VDPAU
  if [[ $(id -u) == 0 ]] ; then
    printf "Installing hardware accelereated video codecs...\n"
